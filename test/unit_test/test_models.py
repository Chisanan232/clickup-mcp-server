...
class TestDomainModels:
    ...
    def test_folder_operations(self):
        ...
        # Create request
        folder_create_req = Folder.create_request(
            space_id="space123",
            name="New Folder"
        )
    ...
    def test_list_operations(self):
        ...
        list_create_space_req = ClickUpListDomain.create_request(
            name="New List",
            space_id="space123"
        )
    ...
    def test_task_operations(self):
        ...
        task_custom_req = Task.get_request(
            task_id="TASK-123",
        ...
        task_custom_delete_req = Task.delete_request(
            task_id="TASK-123",
            custom_task_ids=True,
            team_id="team123"
        )
