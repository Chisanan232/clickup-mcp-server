...
class TestWorkflow:
    ...
    def test_backward_compatible_id_property(self):
        ...
        workflow = Workflow(id="wf_123", team_id="team_456", name="Test")
        assert workflow.id == "wf_123"
        assert workflow.id == workflow.workflow_id

    def test_update_name(self):
        """Test updating workflow name."""
        workflow = Workflow(id="wf_123", team_id="team_456", name="Old Name")
    ...
    def test_update_description(self):
        ...
        workflow = Workflow(id="wf_123", team_id="team_456", name="Test", description="Old Description")
    ...
    def test_update_description_clear(self):
        ...
        workflow = Workflow(id="wf_123", team_id="team_456", name="Test", description="Description")
    ...
    def test_add_action_duplicate_raises_error(self):
        ...
        workflow = Workflow(id="wf_123", team_id="team_456", name="Test", actions=[action])
    ...
    def test_activate(self):
        ...
        workflow = Workflow(id="wf_123", team_id="team_456", name="Test", is_active=False)
        workflow.activate()
        assert workflow.is_active is True

    def test_deactivate(self):
        """Test deactivating workflow."""
        workflow = Workflow(id="wf_123", team_id="team_456", name="Test", is_active=True)
        workflow.deactivate()
    ...
    def test_is_active_workflow(self):
        ...
        active_workflow = Workflow(id="wf_123", team_id="team_456", name="Test", is_active=True)
        inactive_workflow = Workflow(id="wf_124", team_id="team_456", name="Test", is_active=False)
