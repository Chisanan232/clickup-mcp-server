...
from clickup_mcp.config import ClickUpConfig, get_default_config, load_config_from_env
...
class TestClickUpConfigAdvanced:
    ...
    def test_config_with_float_integers(self):
        ...
        config = ClickUpConfig(
            api_token="test", max_retries=5.0, rate_limit_requests_per_minute=100.0  # Float that converts to int
        )
    ...
    def test_config_with_string_numbers(self):
        ...
        config = ClickUpConfig(
            api_token="test", timeout="45.5", max_retries="7", retry_delay="2.5", rate_limit_requests_per_minute="150"
        )
    ...
    def test_config_with_special_characters_in_base_url(self):
        ...
        config = ClickUpConfig(api_token="test", base_url=special_url)
...
class TestLoadConfigFromEnv:
    ...
    def test_load_config_with_minimal_env_vars(self):
        ...
        env_vars = {"CLICKUP_API_TOKEN": "minimal_token"}
    ...
    def test_load_config_invalid_timeout(self):
        ...
        env_vars = {"CLICKUP_API_TOKEN": "test_token", "CLICKUP_TIMEOUT": "invalid_number"}
    ...
    def test_load_config_invalid_max_retries(self):
        ...
        env_vars = {"CLICKUP_API_TOKEN": "test_token", "CLICKUP_MAX_RETRIES": "not_a_number"}
    ...
    def test_load_config_invalid_retry_delay(self):
        ...
        env_vars = {"CLICKUP_API_TOKEN": "test_token", "CLICKUP_RETRY_DELAY": "not_a_float"}
    ...
    def test_load_config_invalid_rate_limit(self):
        ...
        env_vars = {"CLICKUP_API_TOKEN": "test_token", "CLICKUP_RATE_LIMIT_REQUESTS_PER_MINUTE": "not_an_integer"}
    ...
    def test_load_config_with_negative_values(self):
        ...
        with patch.dict(os.environ, env_vars, clear=True):
            ...
            assert (
                "Timeout must be positive" in error_message
                or "Max retries cannot be negative" in error_message
                or "Retry delay cannot be negative" in error_message
                or "Rate limit must be positive" in error_message
            )
...
class TestLoadConfigFromEnvAdvanced:
    ...
    def test_load_config_with_unicode_env_values(self):
        ...
        env_vars = {"CLICKUP_API_TOKEN": "token_🔑_测试", "CLICKUP_BASE_URL": "https://api.example.com/v2/🚀"}
    ...
    def test_load_config_with_whitespace_env_values(self):
        ...
        env_vars = {"CLICKUP_API_TOKEN": "  token_with_spaces  ", "CLICKUP_BASE_URL": "  https://api.example.com/v2  "}
    ...
    def test_load_config_with_zero_values(self):
        ...
        env_vars = {"CLICKUP_API_TOKEN": "test_token", "CLICKUP_MAX_RETRIES": "0", "CLICKUP_RETRY_DELAY": "0.0"}
...
class TestGetDefaultConfig:
    ...
    def test_get_default_config_without_token_with_env(self):
        ...
        env_vars = {"CLICKUP_API_TOKEN": "env_token_123", "CLICKUP_TIMEOUT": "45.0"}
    ...
    def test_get_default_config_with_none_token(self):
        ...
        env_vars = {"CLICKUP_API_TOKEN": "env_fallback_token"}
    ...
    def test_get_default_config_precedence(self):
        ...
        env_vars = {"CLICKUP_API_TOKEN": "env_token", "CLICKUP_TIMEOUT": "60.0"}
...
class TestGetDefaultConfigAdvanced:
    ...
    def test_get_default_config_env_error_handling(self):
        ...
        env_vars = {"CLICKUP_API_TOKEN": "env_token", "CLICKUP_TIMEOUT": "invalid_float"}
    ...
    def test_get_default_config_env_validation_error(self):
        ...
        env_vars = {"CLICKUP_API_TOKEN": "env_token", "CLICKUP_TIMEOUT": "-1.0"}
...
class TestConfigIntegration:
    ...
    def test_config_creation_and_validation_workflow(self):
        ...
        config = ClickUpConfig(api_token="workflow_token", timeout=45.0, max_retries=5)
    ...
    def test_config_with_mock_environment_complex(self):
        ...
        base_env = {"CLICKUP_API_TOKEN": "base_token", "CLICKUP_TIMEOUT": "30.0"}

        override_env = {"CLICKUP_API_TOKEN": "override_token", "CLICKUP_TIMEOUT": "60.0", "CLICKUP_MAX_RETRIES": "10"}
