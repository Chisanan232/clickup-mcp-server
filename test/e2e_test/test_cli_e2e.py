...
class TestClickUpMCPCliE2E:
    ...
    @pytest.mark.parametrize("execution_method", [
        # Module execution method
        [sys.executable, "-m", "clickup_mcp"],
        # Direct CLI entry point execution
        [ENTRY_POINT]
    ])
    def test_help_command(self, execution_method):
    ...
    def test_invalid_arguments(self, execution_method):
    ...
    def test_invalid_log_level(self, execution_method):
    ...
    @pytest.mark.skipif(
        sys.platform != "posix",
        reason="Signal testing is more reliable on POSIX systems"
    )
    @pytest.mark.parametrize("execution_method", [
        # Module execution method
        [sys.executable, "-m", "clickup_mcp"],
