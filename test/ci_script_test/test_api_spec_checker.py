...
class TestApiSpecificationDTO:
    ...
    def test_initialization(self) -> None:
        ...
        sample_spec = {
            "openapi": "3.1.0",
            "info": {"title": "ClickUp API v2 Reference", "version": "2.0"},
            "paths": {"/v2/user": {"get": {"summary": "Get Authorized User"}}},
        }
...
class TestApiSpecChecker:
    ...
    def test_fetch_remote_spec(self, mock_client: mock.MagicMock) -> None:
        ...
        mock_response.json.return_value = {"openapi": "3.1.0", "info": {"title": "ClickUp API", "version": "2.0"}}
    ...
    def test_read_local_spec(self) -> None:
        ...
        sample_spec = {"openapi": "3.1.0", "info": {"title": "ClickUp API", "version": "2.0"}}
    ...
    def test_save_spec(self) -> None:
        ...
        spec = ApiSpecificationDTO.model_validate(
            {"openapi": "3.1.0", "info": {"title": "ClickUp API", "version": "2.0"}}
        )
...
class TestApiSpecChangeDetector:
    ...
    def test_detect_added_endpoint(self) -> None:
        ...
        spec2 = ApiSpecificationDTO.model_validate(
            {
                "openapi": "3.1.0",
                "info": {"title": "ClickUp API", "version": "2.0"},
                "paths": {"/test": {"get": {"summary": "Test"}}, "/new": {"get": {"summary": "New Endpoint"}}},
            }
        )
        ...
        path_added = any(
            diff.change_type == "added" and diff.path.startswith("paths./new") for diff in result.differences
        )
        assert path_added
    ...
    def test_detect_removed_endpoint(self) -> None:
        ...
        path_removed = any(
            diff.change_type == "removed" and diff.path.startswith("paths./to_remove") for diff in result.differences
        )
        assert path_removed
    ...
    def test_detect_modified_endpoint(self) -> None:
        ...
        spec1 = ApiSpecificationDTO.model_validate(
            {
                "openapi": "3.1.0",
                "info": {"title": "ClickUp API", "version": "2.0"},
                "paths": {"/test": {"get": {"summary": "Test", "description": "Old description"}}},
            }
        )
        ...
        spec2 = ApiSpecificationDTO.model_validate(
            {
                "openapi": "3.1.0",
                "info": {"title": "ClickUp API", "version": "2.0"},
                "paths": {"/test": {"get": {"summary": "Test", "description": "Updated description"}}},
            }
        )
        ...
        path_modified = any(
            ...
            and diff.path.startswith("paths./test.get.description")
            and diff.old_value == "Old description"
            and diff.new_value == "Updated description"
...
class TestMainExecution:
    ...
    def test_main_no_changes(self, mock_detector_class: mock.MagicMock, mock_checker_class: mock.MagicMock) -> None:
        ...
        with mock.patch(
            "sys.argv",
            ["api_spec_checker.py", "--spec-url", "https://example.com/spec", "--local-spec", "local_spec.json"],
        ):
    ...
    def test_main_with_changes(self, mock_detector_class: mock.MagicMock, mock_checker_class: mock.MagicMock) -> None:
        ...
        mock_result.differences = [
            SpecificationDifference(path="info.version", change_type="modified", old_value="2.0", new_value="2.1")
        ]
        mock_detector.compare_specs.return_value = mock_result
