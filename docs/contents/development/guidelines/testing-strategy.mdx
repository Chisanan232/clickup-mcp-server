...
- Use the `test_settings` pytest fixture for accessing test configuration (see [Test Configuration & Settings](./test-configuration.mdx)).
...
- [Test Configuration & Settings](./test-configuration.mdx)
:::
