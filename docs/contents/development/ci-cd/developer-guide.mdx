...
This guide provides comprehensive information for developers working with the clickup-mcp-server CI/CD system, including troubleshooting, configuration management, specialized workflows, and best practices.
...
Edit [.github/tag_and_release/intent.yaml](https://github.com/Chisanan232/clickup-mcp-server/blob/master/.github/tag_and_release/intent.yaml) to configure your release:
...
#### 3. Documentation Versioning Issues
...
- Check that Docusaurus plugin IDs in `sections` array exist in [docusaurus.config.ts](https://github.com/Chisanan232/clickup-mcp-server/blob/master/docs/docusaurus.config.ts)
...
**Testing**: Use [release-validate.yml](https://github.com/Chisanan232/clickup-mcp-server/blob/master/.github/workflows/release-validate.yml) workflow to test configuration changes
...
**Primary Workflows**:
- [Release Workflow](https://github.com/Chisanan232/clickup-mcp-server/actions/workflows/release.yml)
- [Validation Results](https://github.com/Chisanan232/clickup-mcp-server/actions/workflows/release-validate.yml)
...
python -c "import clickup_mcp; print(clickup_mcp.__version__)"
```
...
**Purpose**: Verifies the ClickUp API specification against the implementation

**Features**:
- Automated API specification validation
- Detects breaking changes in API contracts
- Ensures implementation matches documented API
- Prevents API drift and inconsistencies

**Triggers**:
- Changes to API specification files
- Changes to API implementation code
- Scheduled weekly runs for proactive monitoring
...
### Core Workflows
- [ci.yaml](https://github.com/Chisanan232/clickup-mcp-server/blob/master/.github/workflows/ci.yaml) - Main CI workflow with comprehensive testing
- [release.yml](https://github.com/Chisanan232/clickup-mcp-server/blob/master/.github/workflows/release.yml) - Modern intent-driven release system
- [release-validate.yml](https://github.com/Chisanan232/clickup-mcp-server/blob/master/.github/workflows/release-validate.yml) - Pre-release validation workflow  
- [release-staging.yml](https://github.com/Chisanan232/clickup-mcp-server/blob/master/.github/workflows/release-staging.yml) - Staging environment deployment
- [documentation.yaml](https://github.com/Chisanan232/clickup-mcp-server/blob/master/.github/workflows/documentation.yaml) - Documentation building and deployment
...
- `check-clickup-api-spec.yaml` - API specification validation
...
**Browse All Workflows**: [Workflow Definitions](https://github.com/Chisanan232/clickup-mcp-server/tree/master/.github/workflows)
