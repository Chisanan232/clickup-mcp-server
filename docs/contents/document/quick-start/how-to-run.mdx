...
:::tip CLI reference
For a complete command reference (server and webhook consumer) including synopsis, options, environment variables, transports, and examples, see [CLI usages and scenarios](./cli-usage.mdx).
:::
...
1. Create a `.env` file in your project directory:
   ...
   CORS_ALLOW_ORIGINS=["https://app.clickup.com"]
   ```
