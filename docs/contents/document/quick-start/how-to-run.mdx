...
2. Specify the path to your `.env` file when starting the server:
   ...
   <Tabs>
     ...
     ```bash
     poetry run clickup-mcp-server --env /path/to/.env
     ```

     </TabItem>
     <TabItem value="uv" label="uv">
     ```bash
     uv run clickup-mcp-server --env /path/to/.env
     ```
...
<Tabs>
  ...
  <TabItem value="poetry" label="poetry">
  ```bash
  poetry run clickup-mcp-server --token your_clickup_api_token
  ```

  </TabItem>
  <TabItem value="uv" label="uv">
  ```bash
  uv run clickup-mcp-server --token your_clickup_api_token
  ```
...
<Tabs>
  ...
  <TabItem value="poetry" label="poetry">
  ```bash
  poetry run clickup-mcp-server
  ```

  </TabItem>
  <TabItem value="uv" label="uv">
  ```bash
  uv run clickup-mcp-server
  ```
...
<Tabs>
  ...
  For HTTP streaming (default)
  ```bash
  poetry run clickup-mcp-server --transport http-streaming
  ```

  For SSE 
  ```bash
  poetry run clickup-mcp-server --transport sse
  ```
  ...
  For HTTP streaming (default)
  ```bash
  uv run clickup-mcp-server --transport http-streaming
  ```

  For SSE 
  ```bash
  uv run clickup-mcp-server --transport sse
  ```
...
<Tabs>
  ...
  <TabItem value="poetry" label="poetry">
  ```bash
  poetry run clickup-mcp-server --port 8080
  ```

  </TabItem>
  <TabItem value="uv" label="uv">
  ```bash
  uv run clickup-mcp-server --port 8080
  ```
...
<Tabs>
  ...
  <TabItem value="poetry" label="poetry">
  ```bash
  poetry run clickup-mcp-server --env /path/to/.env --transport sse --port 8080
  ```

  </TabItem>
  <TabItem value="uv" label="uv">
  ```bash
  uv run clickup-mcp-server --env /path/to/.env --transport sse --port 8080
  ```
...
For production deployments, you may want to run the server as a system service using systemd, supervisor, or similar tools.
Configuration examples can be found in the [Development Guide].

[Development Guide]: ../../development/deployment.mdx
