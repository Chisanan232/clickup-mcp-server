          ...
          items: [
            ...
            'api-references/mcp-server/mcp-errors-and-retries',
            {
              ...
              items: [
                ...
                'api-references/mcp-server/tools/time-mcp-api',
                'api-references/mcp-server/tools/goal-mcp-api',
                'api-references/mcp-server/tools/key-result-mcp-api',
                'api-references/mcp-server/tools/workflow-mcp-api',
                'api-references/mcp-server/tools/bottleneck-mcp-api',
                'api-references/mcp-server/tools/insights-mcp-api',
                'api-references/mcp-server/tools/reporting-mcp-api',
