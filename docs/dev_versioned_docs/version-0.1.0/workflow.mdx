...
Before you start development, make sure you have completed all the steps in the [Requirements](guidelines/requirements.mdx) guide.

## Development Process

### 1. Pick or Create an Issue

- Browse existing [GitHub Issues](https://github.com/Chisanan232/clickup-mcp-server/issues) to find something to work on
...
1. Go to the [ClickUp MCP Server repository](https://github.com/Chisanan232/clickup-mcp-server)
...
- Follow the [Coding Style and Rules](guidelines/coding-style.mdx)
...
<Tabs>
  ...
  <TabItem value="poetry" label="poetry">
    ...
    # Run with coverage report
    poetry run pytest --cov=clickup_mcp_server
  ...
  <TabItem value="uv" label="uv">
    ...
    # Run with coverage report
    uv run pytest --cov=clickup_mcp_server
...
- Ask questions in the [GitHub Discussions](https://github.com/Chisanan232/clickup-mcp-server/discussions)
