...
[![GitHub release](https://img.shields.io/github/v/release/Chisanan232/clickup-mcp-server?display_name=tag&color=24292e&logo=github)](https://github.com/Chisanan232/clickup-mcp-server/releases)
...
### Production release ([release.yml](https://github.com/Chisanan232/clickup-mcp-server/blob/master/.github/workflows/release.yml))
...
[![PyPI version](https://img.shields.io/pypi/v/clickup-mcp-server?label=PyPI&color=306998&logo=pypi)](https://pypi.org/project/clickup-mcp-server/)
...
### Release staging ([release-staging.yml](https://github.com/Chisanan232/clickup-mcp-server/blob/master/.github/workflows/release-staging.yml))
...
[![TestPyPI version](https://img.shields.io/badge/dynamic/json?label=TestPyPI&color=ff6600&query=%24.info.version&url=https%3A%2F%2Ftest.pypi.org%2Fpypi%2Fclickup-mcp-server%2Fjson&logo=pypi)](https://test.pypi.org/project/clickup-mcp-server/)
...
### Release validation ([release-validate.yml](https://github.com/Chisanan232/clickup-mcp-server/blob/master/.github/workflows/release-validate.yml))
...
- **Configuration-driven**: Child projects configure releases via [intent.yaml](https://github.com/Chisanan232/clickup-mcp-server/blob/master/.github/tag_and_release/intent.yaml), delegating implementation details to the centralized workflows.
...
- Maintain [intent.yaml](https://github.com/Chisanan232/clickup-mcp-server/blob/master/.github/tag_and_release/intent.yaml) to control release behavior for this project.
