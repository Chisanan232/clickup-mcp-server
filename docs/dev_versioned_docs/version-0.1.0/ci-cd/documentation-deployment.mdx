...
The documentation workflow ([documentation.yaml](https://github.com/Chisanan232/clickup-mcp-server/blob/master/.github/workflows/documentation.yaml)) handles building and deploying project documentation using **dual trigger mechanisms** to ensure reliable deployment after releases. This system solves critical GitHub Actions limitations for automated documentation updates during releases.
...
The **release workflow** ([release.yml](https://github.com/Chisanan232/clickup-mcp-server/blob/master/.github/workflows/release.yml)) has been enhanced to support this pattern through the `DOCS_UPDATED` flag system.
