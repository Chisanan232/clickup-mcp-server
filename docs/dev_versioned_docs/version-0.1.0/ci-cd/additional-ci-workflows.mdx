...
**Triggers:**
- **Daily schedule**: Runs at 00:00 UTC to check for API changes
- **Manual dispatch**: Can be triggered manually for testing

**Purpose**: Ensures our MCP server implementation stays in sync with ClickUp's API changes.

**Key Features:**
- Automated daily monitoring of ClickUp API specification changes
- Proactive detection of breaking changes or new features
- Integration with project maintenance workflow
...
[![Docs-only auto-approve & automerge](https://github.com/Chisanan232/clickup-mcp-server/actions/workflows/docs-automerge.yml/badge.svg)](https://github.com/Chisanan232/clickup-mcp-server/actions/workflows/docs-automerge.yml)
