        ...
        for key in new_dict:
            ...
            if key not in old_dict:
                ...
                # Both are dictionaries, recurse
                    ...
                    differences.extend(
                        self._compare_dicts(old_value, new_value, current_path)
                    )
...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        description="Check for changes in the ClickUp API specification"
    )
    parser.add_argument(
        "--spec-url",
    ...
    try:
        ...
        if result.has_changes:
            ...
            if args.update:
                ...
                logger.error(
                    "API specification has changed! Update the client and specification."
                )
                return 1
        else:
